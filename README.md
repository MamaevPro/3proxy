...
Install :
    ...
    wget --no-check-certificate https://raw.github.com/MamaevPro/3proxy/master/3proxyinstall.sh
...
Uninstall:
	...
	wget --no-check-certificate https://raw.github.com/SnoyIatk/MamaevPro/master/3proxyuninstall.sh
